        ...
        >
          ...
          <div>
            ...
            <select
              ...
              className="w-full mt-1 p-3 rounded-xl bg-gray-800 text-white placeholder-gray-400 outline-none focus:ring-2 focus:ring-blue-500 transition"
            >
              <option className="bg-gray-800 text-white" value="active">
                Active
              </option>
              <option className="bg-gray-800 text-white" value="inactive">
                Inactive
              </option>
              <option className="bg-gray-800 text-white" value="blocked">
                Blocked
              </option>
              <option className="bg-gray-800 text-white" value="deleted">
                Deleted
              </option>
            </select>
          </div>
